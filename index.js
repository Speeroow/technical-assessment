...
document.addEventListener("DOMContentLoaded", function () {
  // == .custmonDropDwon == //
  var customDropDowns = document.querySelectorAll(".customDropDown");
  customDropDowns.forEach(function (dropdown) {
    dropdown.addEventListener("click", function (e) {
      var target = e.target;
      if (
        target.classList.contains("crossString") ||
        target.classList.contains("bowiro")
      ) {
        return false;
      }
      ...
      if (
        ...
        target.parentElement.classList.contains("language")
      ) {
        languageFunc();
      }
      ...
      if (target.classList.contains("searchCoinDrp")) {
        document.getElementById("tokensearch1").focus();
      }

      var customDrp = this.nextElementSibling;
      if (customDrp) {
  ...
  document
    ...
    .addEventListener("click", function () {
      document.querySelectorAll(".customDrp").classList.remove("active");
    });
  ...
  document
    .querySelectorAll(".currenciesTable, .exchangeTable")
...
// ==  .LoginSignUpBox == //
document.querySelectorAll(".LoginSignUpBox .TabsHead").forEach(function (tab) {
  tab.addEventListener("click", function () {
    let obj = this;
    obj.classList.add("active");
    Array.from(obj.parentNode.children).forEach(function (sibling) {
      if (sibling !== obj) {
        sibling.classList.remove("active");
      }
    });
    var tabName = obj.getAttribute("data-tab");
    document
      .querySelectorAll(".LoginSignUpBox ." + tabName)
      .forEach(function (panel) {
        panel.classList.add("active");
      });
    document
      .querySelectorAll(".LoginSignUpBox .panel.active")
      .forEach(function (panel) {
        if (panel !== document.querySelector(".LoginSignUpBox ." + tabName)) {
...
document.querySelectorAll(".popupRemover").forEach(function (remover) {
  remover.addEventListener("click", function () {
    document.querySelectorAll("#LoginBox, #signUpBox").forEach(function (box) {
...
isHighLight.addEventListener("click", function () {
  document.querySelectorAll(".Banner_cards").forEach(function (element) {
...
// == == == faq scripts == == == //
document
  .querySelectorAll(".faqAcc .flexAccHead")
  .addEventListener("click", function () {
    let AccHeadObj = this;
